 ...
 */
public class RBlastMoleculeSignature extends AbstractGraphSignature {
    ...
    public String signatureStringForVertex(int atomIndex) {
        return new RBlastAtomSignature(atomIndex, atomContainer).toCanonicalString();
    }

    @Override
    public String signatureStringForVertex(int atomIndex, int height) {
        return new RBlastAtomSignature(atomIndex, atomContainer, height).toCanonicalString();
    }
    ...
    // === Inner classes (RBlastSmilesGenerator, RBlastMoleculeFromSignatureBuilder) ===
     ...
     *
     */
    public static class RBlastAtomSignature extends AbstractVertexSignature {
     ...
     * @cdk.bug 1793446
     */
    public static class RBlastSmilesGenerator {
     ...
     *
     */
    public static class RBlastMoleculeFromSignatureBuilder extends AbstractGraphBuilder {
...
// === Package-private class (merged from separate file) ===
 ...
 *
 */
class RBlastMoleculeSignatureLabellingAdaptor
