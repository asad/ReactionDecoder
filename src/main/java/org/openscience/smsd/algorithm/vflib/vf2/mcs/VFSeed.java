...
/**
 * A structure pattern which utilises the Vento-Foggia (VFSeed) algorithm {
 *
 * @cdk.cite Cordella04}.
 *
 * <p/>
 ...
 * Pattern        pattern = VF.findSeeds(query);
 *
 * int hits = 0;
...
public final class VFSeed extends Pattern {
     ...
     */
    private VFSeed(IAtomContainer query, boolean shouldMatchBonds, boolean shouldMatchRings, boolean matchAtomType) {
        this.query = query;
