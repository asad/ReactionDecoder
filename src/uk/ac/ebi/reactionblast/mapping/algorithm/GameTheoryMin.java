...
import uk.ac.ebi.reactionblast.mapping.algorithm.checks.IsomorphismMin;import uk.ac.ebi.reactionblast.mapping.algorithm.checks.ReactionIsomorphismHandler;
...
class GameTheoryMin extends BaseGameTheory {
    ...
    GameTheoryMin(
            ...
            throws Exception {
        if (DEBUG) {
            System.out.println("I am MIN MIX");
        }
...
//            printEnergyMatrix(mh, eductList, productList);
        ...
        if (!ruleMatchingFlag) {
            ...
            if (ph.isMatchFound()) {
                if (DEBUG) {
                    System.out.println("RuleBasedMappingHandler Match Found");
                }
        ...
        if (!conditionmet) {
            if (DEBUG) {
                System.out.println("Subgraph/Exact Match Test");
            }
            IsomorphismMin SMCM
