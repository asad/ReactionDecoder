    ...
    private synchronized void run() {
        switch (algorithm) {
            case MIN:
                ...
                delta = calRelation(reaction, IMappingAlgorithm.MIN);
                break;
            case MAX:
                logger.debug("Processing Reaction for Global Minimum: ");
                delta = calRelation(reaction, IMappingAlgorithm.MAX);
                break;
            case MIXTURE:
                logger.debug("Processing Reaction for Max-Mixture Model: ");
                delta = calRelation(reaction, IMappingAlgorithm.MIXTURE);
                break;
            case RINGS:
                logger.debug("Processing Reaction for Ring Model: ");
                delta = calRelation(reaction, IMappingAlgorithm.RINGS);
                break;
        }
    }
