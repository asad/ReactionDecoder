...
public abstract class MDLWriterBase extends DefaultChemObjectWriter {
    ...
    protected void writeAtomValue(BufferedWriter writer, IAtomContainer container) throws IOException {
        ...
        for (int i = 0; i < container.getAtomCount(); i++) {
            ...
            if (atom.getProperty(CDKConstants.COMMENT) != null && atom.getProperty(CDKConstants.COMMENT) instanceof String && !atom.getProperty(CDKConstants.COMMENT).trim().equals("")) {
                writer.write("V  ");
