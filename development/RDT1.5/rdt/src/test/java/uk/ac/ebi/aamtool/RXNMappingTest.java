...
public class RXNMappingTest extends MappingUtility {
    ...
    public void Test() throws Exception {
        ...
        System.out.println("FP " + new SmilesGenerator().withAtomClasses().createReactionSMILES(testReactions.getSelectedSolution().getReactor().getReactionWithAtomAtomMapping()));
...
//    /*
//     *  MIN, fp 
//     *  ID=R05069:Bond Cleaved and Formed (2) [C-C:2.0]
//     *  ID=R05069:Bond Order Change (1) [C-O*C=O:2.0]
//     *  BE 692.0, Fragment 0
//     * 
//     *
//     * @throws Exception
...
//     * @COMPLEX CASE.
//     * MIN, fp 
//     * Mapping Reaction R04558
//     * Reaction ID: R04558, Selected Algorithm: MIN
//     *
//     * ID=R04558:Bond Cleaved and Formed (4)
//     * [C-N:3.0, C-O:1.0, C=O:1.0, C@N:1.0]
//     * 
//     * MIN, fp 
