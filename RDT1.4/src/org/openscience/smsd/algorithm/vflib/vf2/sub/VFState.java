 ...
 * @cdk.cite Cordella04}.
 * <p/>
 * Note: no heuristics or sorting are performed as all and should be checked
 * externally
 *
 * @author John May
...
final class VFState extends AbstractVFState {
     ...
     * vertex (terminal) then the number of such edges should be equal in g1
     * compared to g2 (1-look-ahead). If the edge is unmapped and non-terminal
     * then the number of such edges should be equal in g1 compared to g2
     * (2-look-ahead).
     * <p/>
     *
